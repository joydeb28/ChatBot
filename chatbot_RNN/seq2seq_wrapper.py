    ...
    def __init__(self, xseq_len, yseq_len, 
        ...
        def __graph__():
            ...
            with tf.variable_scope('decoder') as scope:
                ...
                self.decode_outputs_test, self.decode_states_test = tf.nn.seq2seq.embedding_rnn_seq2seq(self.enc_ip, self.dec_ip, stacked_lstm, xvocab_size, yvocab_size,emb_dim,feed_previous=True)
